...
def dec(request):
    ...
    encoded_text = request.GET.get('encoded_text', 'default')
    rot_version = request.GET.get('rot_versions', 'default') 
    print(rot_version)
    decrypt_text = decrypt.Rot(encoded_text, int(rot_version))
    decrypted_text = decrypt_text.decryptor()
    #params = {'dec_txt':decrypted_text}
    algorithms={
        "102020":"ADLER-32", 
        "102040":"CRC-32", 
        "102060":"CRC-32B", 
